...
rDownloadURL = {"main": "http://download1319.mediafire.com/rcmjg0byuoig/hmxw4phqycjeq8d/main.tar.gz", "sub": "http://download1349.mediafire.com/lnf7v5r378og/qik3uv75i72ozaf/sub.tar.gz"}
...
if __name__ == "__main__":
    ...
    else: printc("Invalid installation type", col.FAIL)cat: '}': No existe el fichero o el directorio
